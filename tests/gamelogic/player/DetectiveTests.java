...
public class DetectiveTests extends PlayerTests {
	...
	@Test
	@Parameters
	public void detectivesMovesChangesTheNumberOfTokens(
			int expectedUndergroundTokens, int expectedBusTokens,
			int expectedTaxiTokens, int numberOfMoves, Edge edge)
			throws Exception {
	...
	private Object[] parametersForDetectivesMovesChangesTheNumberOfTokens() {
		return $($(4, 8, 11, 0, createUndergroundEdge()),
