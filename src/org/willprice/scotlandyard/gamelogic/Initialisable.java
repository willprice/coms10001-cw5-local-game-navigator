...
public interface Initialisable {
	...
	/**
	 * Function to initialise the state of the Game given a number of
	 * detectives. To check how to correctly initialise the game check the rules
	 * for 'Scotland Yard'
	 * 
	 * @param numberOfDetectives
	 *            The number of detectives that will be playing
