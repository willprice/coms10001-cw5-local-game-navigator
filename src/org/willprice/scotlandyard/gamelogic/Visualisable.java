 ...
 */
public interface Visualisable extends Initialisable, MapVisualisable,
		PlayerVisualisable {

	/**
	 * Function to retrieve the number of tickets of a certain type held by a
	 * player
	 * 
	 * @param type
	 *            The type of ticket you are checking for
	 * @param playerId
	 *            The id of the player you are looking up
	...
	/**
	 * Function to retrieve the list of previous move types that a player has
	 * taken
	 * 
	 * @param playerId
	 *            The id of player you are looking up
	 * @return The list of moves that a player has made
	 */
	public List<TicketType> getMoveList(Integer playerId);

	/**
	 * Check if a player is visible. The detectives are going to be visible at
	 * all times, Mr X is not..
	 * 
	 * @param playerId
	 *            The id of the player you are checking
