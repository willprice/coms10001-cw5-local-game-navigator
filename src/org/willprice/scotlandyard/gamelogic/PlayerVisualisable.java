...
/**
 * Interface that enables information about displaying player information to be
 * extracted
 */
public interface PlayerVisualisable {
	 ...
	 * 
	 * @param nodeId
	 *            The node id you wish to find the location of
	...
	/**
	 * Function to get the list of Mr X IDs. In this version of the game you
	 * will really only have one Mr X so this function will return a list with
	 * only one entry. However this may change down the line...
	 * 
	...
	/**
	 * Function to retireve the current location of a player. The location is an
	 * id of a graph node
	 * 
	 * @param playerId
