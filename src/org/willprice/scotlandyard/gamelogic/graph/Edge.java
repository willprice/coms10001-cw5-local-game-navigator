...
public class Edge {
	...
	/**
	 * Function to find out given one node, what the other node name is This
	 * function also checks if the node passed in extaully is connected by this
	 * edge. If it isn't it will return null
	 * 
	 * @param n
	 *            The node name that we want to find the neighbour of
	 ...
	 * function and cannot be changed afterwards
	 * 
	 * @param id1
